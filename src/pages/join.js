      ...
      <section className="light bg-primary-800 text-primary-200 flex flex-col justify-center items-center text-center min-h-[400px] px-4 md:px-6 py-4 md:py-0">
        <div className="space-y-6 max-w-[900px]">
          ...
          <p className="text-lg lg:text-xl max-w-[64ch]">
            ...
            communities, projects and stakeholders. In doing so we'll enable the
            success of customers, users, partners, and contributors as we deepen
            our knowledge and experiences together.
          </p>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 my-12 md:my-0 gap-8 page-wrapper">
          <div className="flex flex-col h-full">
            ...
            <p className={paragraphStyle}>
              ...
              To do this we'll act as resources for each other, share best
              practices and provide a forum for peer-to-peer communication.
            </p>
          </div>
          <div
            id="elq-iframe-signup-container"
            className="dark:bg-base-600 lg:order-3"
          >
            <iframe
          ...
          <div className="mt-8 lg:mt-0 lg:order-2 flex flex-col h-full">
            ...
            <p className={paragraphStyle}>
              Users, partners, customers, and contributors come together to
          ...
          <div className="flex flex-col gap-8 lg:order-4">
            ...
            <Callout
              ...
              icon={<Edit alt="" />}
            >
              Blogs are open for contribution. Is there a topic you are
              interested in? Let the organizers know about&nbsp;it.{' '}
            ...
            <Callout
              ...
              icon={<Calendar alt="" />}
            >
              Events are lead by an OpenShift expert who would love to answer
