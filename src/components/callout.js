...
const Callout = ({ ...props }) => {
  ...
  return (
    <a
      ...
      className={`group flex lg:h-full flex-col space-y-2 min-h-[112px] ring-2 ring-primary-600 ring-inset ring-opacity-10 hover:ring-opacity-50 focus:ring-opacity-100 focus:outline-none focus:ring-outset bg-gradient-to-br ${
        type === 'tertiary' &&
